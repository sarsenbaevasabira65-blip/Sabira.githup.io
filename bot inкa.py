...
SERVICES = {
    "photo": {
        ...
        "price_kz": "1 фото —100-1000 ₸",
        "price_ru": "1 фото — 100-1000 ₸",
    },
    "video": {
        "name_kz": "🎬 Видео жасау (AI)",
        "name_ru": "🎬 Создание видео (AI)",
        "price_kz": "15 сек — 1000 -5 000 ₸",
        "price_ru": "15 сек — 1000 -5 000 ₸",
    },
}
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Менеджер
        ...
        text = (
            f"📞 Менеджер: "+77474513371"{}"
            if lang == "kz"
            else f"📞 Менеджер: {"+77474513371"}"
        )
...
# ========================
def main():
    app = Application.builder().token "8754227384:AAFlaA-7Bq6wVR8wVAOZqUwY86bCjJuJG4k"().build()
